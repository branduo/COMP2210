 ...
 */
   ...
   public static <T> T ceiling(Collection<T> coll, T key, Comparator<T> comp) {
      ...
      T ceiling = null;
      Iterator<T> itr = coll.iterator();
      boolean found = false; //if first ceiling is found
      while (itr.hasNext()) {
         T temp = itr.next();
         
         //if first ceiling isn't found, compare to key
         if (!found && comp.compare(temp, key) >= 0) {
            ceiling = temp;
            found = true;
         }
         
         //if first ceiling is found, compare to key and current ceiling
   ...
   public static <T> T floor(Collection<T> coll, T key, Comparator<T> comp) {
      ...
      T floor = null;
      Iterator<T> itr = coll.iterator();
      boolean found = false; //if first floor is found
      while (itr.hasNext()) {
         T temp = itr.next();
         //if first floor isn't found, compare to key
         if (!found && comp.compare(temp, key) <= 0) {
            floor = temp;
            found = true;
         }
         //if first floor is found, compare to key and current floor
